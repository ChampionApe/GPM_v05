...
$BLOCK M_Abatement_minobj 
	E_minobj..	minobj =E= weight_sigma * sum(n$(minobj_sigma_subset[n]), Sqr(sigma[n] - minobj_sigma[n])) + weight_mu * sum([n,nn]$(minobj_mu_subset[n,nn]), Sqr(mu[n,nn] - minobj_mu[n,nn]));
$ENDBLOCK

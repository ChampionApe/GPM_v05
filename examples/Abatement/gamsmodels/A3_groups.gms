...
$GROUP A3_g_ID_mu_endoincalib_CNScalib
mu[n,nn]$(ID_mu_endoincalib_CNScalib[n,nn]) ""
;

$GROUP A3_g_ID_mu_exo_CNScalib
mu[n,nn]$(ID_mu_exo_CNScalib[n,nn]) ""
;

@load_level(A3_g_ID_alwaysendo,%qmark%%ID_0%");
@load_level(A3_g_ID_currapp,%qmark%%ID_0%");
@load_level(A3_g_ID_mu_endoincalib_CNScalib,%qmark%%ID_0%");
...
@load_fixed(A3_g_ID_mu_exo_CNScalib,%qmark%%ID_0%");

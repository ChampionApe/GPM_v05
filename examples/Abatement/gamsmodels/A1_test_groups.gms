...
$GROUP A1_test_g_ID_endoincalib
mu[n,nn]$(ID_mu_endoincalib[n,nn]) ""
gamma_tau[n,nn]$((ID_e2t[n,nn] and kno_ID_TU[nn])) ""
;

@load_level(A1_test_g_ID_alwaysendo,%qmark%%ID_0%");
@load_level(A1_test_g_ID_exoincalib,%qmark%%ID_0%");
@load_fixed(A1_test_g_ID_alwaysexo,%qmark%%ID_0%");
@load_fixed(A1_test_g_ID_endoincalib,%qmark%%ID_0%");

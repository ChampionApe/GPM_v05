...
$GROUP A1_g_EOP_exoincalib
currapp_EOP[z,n]$(m2t[z,n]) ""
;

$GROUP A1_g_ID_alwaysexo
...
@load_level(A1_g_ID_alwaysendo,%qmark%%ID_0%");
@load_level(A1_g_ID_exoincalib,%qmark%%ID_0%");
@load_level(A1_g_EOP_alwaysendo,%qmark%%ID_0%");
@load_level(A1_g_EOP_exoincalib,%qmark%%ID_0%");
@load_fixed(A1_g_ID_alwaysexo,%qmark%%ID_0%");
@load_fixed(A1_g_ID_endoincalib,%qmark%%ID_0%");
@load_fixed(A1_g_EOP_alwaysexo,%qmark%%ID_0%");
@load_fixed(A1_g_EOP_endoincalib,%qmark%%ID_0%");

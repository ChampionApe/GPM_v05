...
$GROUP G_g_exo_dyn
irate[t] "irate[t]"
vD[t,s,n]$((gsvngs[n] and s_G[s] and t0[t])) "vD[t,s,n]"
;

@load_level(G_g_endo,%qmark%%GE_data_6%");
@load_fixed(G_g_calib_endo,%qmark%%GE_data_6%");
@load_fixed(G_g_exo,%qmark%%GE_data_6%");
@load_fixed(G_g_exo_dyn,%qmark%%GE_data_6%");

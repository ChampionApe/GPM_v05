$BLOCK M_nest 
	E_zp_out_nest[t,s,n]$(I_out_nest[s,n] and txE[t])..	PbT[t,s,n]*qS[t,s,n] =E= sum(nn$(map_nest[s,nn,n]), qD[t,s,nn]*PwT[t,s,nn]);
...
$ENDBLOCK
$BLOCK M_inv_pw 
	E_pw_inv[t,s,n]$(I_out[s,n] and txE[t])..	Peq[t,n] =E= (1+markup[s,n])*(PbT[t,s,n]*(1+tauLump[t,s]/sum(nn$(I_out[s,nn]), qS[t,s,nn]*PbT[t,s,nn]))+tauS[t,s,n]+0);
$ENDBLOCK
